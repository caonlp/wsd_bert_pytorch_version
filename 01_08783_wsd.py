...
def train():
    ...
    torch.save(model, "08783_wsd_model.pkl")
    torch.save(model.state_dict(), '08783_wsd_model_params.pkl')

def reload_model():
    train_model = torch.load('08783_wsd_model.pkl')
    return train_model
