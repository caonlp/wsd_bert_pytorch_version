...
def train():
    ...
    torch.save(model, "21128_wsd_model.pkl")
    torch.save(model.state_dict(), '21128_wsd_model_params.pkl')

def reload_model():
    train_model = torch.load('21128_wsd_model.pkl')
    return train_model
