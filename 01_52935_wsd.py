...
def train():
    ...
    torch.save(model, "52935_wsd_model.pkl")
    torch.save(model.state_dict(), '52935_wsd_model_params.pkl')

def reload_model():
    train_model = torch.load('52935_wsd_model.pkl')
    return train_model
