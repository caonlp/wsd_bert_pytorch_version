...
def load_wsd_train_x():
    wsd_train_x = codecs.open('24646_train_data', mode = 'r', encoding= 'utf-8')
...
def load_wsd_test_x():
    wsd_test_x = codecs.open('24646_test_data', mode = 'r', encoding= 'utf-8')
...
def load_wsd_train_y():
    wsd_train_y = codecs.open('24646_train_target', mode = 'r', encoding = 'utf-8')
...
def load_wsd_test_y():
    wsd_test_y = codecs.open('24646_test_target', mode = 'r', encoding = 'utf-8')
...
def train():
    ...
    for epoch in range(max_epoch):
        ...
        if max_acc < accuracy:
            max_acc = accuracy
            torch.save(model, "24646_wsd_max_model.pkl")
            torch.save(model.state_dict(), '24646_wsd_max_model_params.pkl')
        

def reload_model():
    train_model = torch.load('24646_wsd_max_model.pkl')
    return train_model
...
def test():
    ...
    print('24646 Best Test Accuracy: {}/{} ({:.1f}%)\n'.format(
