...
def train():
    ...
    torch.save(model, "49812_wsd_model.pkl")
    torch.save(model.state_dict(), '49812_wsd_model_params.pkl')

def reload_model():
    train_model = torch.load('49812_wsd_model.pkl')
    return train_model
