...
def train():
    ...
    torch.save(model, "14411_wsd_model.pkl")
    torch.save(model.state_dict(), '14411_wsd_model_params.pkl')

def reload_model():
    train_model = torch.load('14411_wsd_model.pkl')
    return train_model
