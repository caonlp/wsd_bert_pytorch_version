...
def train():
    ...
    torch.save(model, "31640_wsd_model.pkl")
    torch.save(model.state_dict(), '31640_wsd_model_params.pkl')

def reload_model():
    train_model = torch.load('31640_wsd_model.pkl')
    return train_model
