...
def train():
    ...
    torch.save(model, "17877_wsd_model.pkl")
    torch.save(model.state_dict(), '17877_wsd_model_params.pkl')

def reload_model():
    train_model = torch.load('17877_wsd_model.pkl')
    return train_model
