...
def train():
    ...
    torch.save(model, "37713_wsd_model.pkl")
    torch.save(model.state_dict(), '37713_wsd_model_params.pkl')

def reload_model():
    train_model = torch.load('37713_wsd_model.pkl')
    return train_model
