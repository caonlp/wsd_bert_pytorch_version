...
def train():
    ...
    for epoch in range(max_epoch):
        ...
        if max_acc < accuracy:
            max_acc = accuracy
            torch.save(model, "20676_wsd_max_model.pkl")
            torch.save(model.state_dict(), '20676_wsd_max_model_params.pkl')
       

def reload_model():
    train_model = torch.load('20676_wsd_max_model.pkl')
    return train_model
...
def test():
    ...
    print('20676 Best Test Accuracy: {}/{} ({:.1f}%)\n'.format(
