...
def train():
    ...
    torch.save(model, "24646_wsd_model.pkl")
    torch.save(model.state_dict(), '24646_wsd_model_params.pkl')

def reload_model():
    train_model = torch.load('24646_wsd_model.pkl')
    return train_model
