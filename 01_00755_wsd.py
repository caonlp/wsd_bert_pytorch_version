...
def train():
    ...
    torch.save(model, "00755_wsd_model.pkl")
    torch.save(model.state_dict(), '00755_wsd_model_params.pkl')

def reload_model():
    train_model = torch.load('00755_wsd_model.pkl')
    return train_model
